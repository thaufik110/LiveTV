...
<body>
    <div class="container">
        <h1>Trans TV</h1>
        <iframe allow="encrypted-media" allowfullscreen="" frameborder="1" gesture="media" height="200" marginheight="0px" marginwidth="0px" name="streaming 14" referrerpolicy="no-referrer" sandbox="allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-top-navigation" scrolling="no" src="https://20.detik.com/watch/livestreaming-transtv" style="border: 0px #ffffff none;" width="100%"></iframe>
