...
<body>
    <div class="container">
            <h1>SKY SPORT</h1>
            <iframe allow="encrypted-media" allowfullscreen="" frameborder="1" gesture="media" height="200" marginheight="0px" marginwidth="0px" name="streaming 14" referrerpolicy="no-referrer" sandbox="allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-top-navigation" scrolling="no" src="https://live.sportsnews.id/p/sky-251.html" style="border: 0px #ffffff none;" width="100%"></iframe>
    ...
    <button id="openChat" class="open-chat-btn">Chat</button> <!-- Button to open chat pop-up -->

    <div id="chatPopup" class="popup">
        <span class="close" id="closeChat">&times;</span> <!-- Close button -->
        <h2>Live Chat</h2>
